...
namespace WaferMapLibrary
{
    ...
    public static class WaferMap
    {
        ...
        /// <returns></returns>
        public static int QueryUserPos(int indexX, int intexY, out double userPosX, out double userPosY)
        {
        ...
        /// <returns></returns>
        public static int QueryEncode(int indexX, int indexY, out double encodeX, out double encodeY)
        {
